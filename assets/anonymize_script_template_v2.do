...
**
**	NOTES:		This script was automatically generated by IPA's PII detector app. For details, check https://github.com/PovertyAction/PII_detection
**
...
**D. Hash an ID
	/*
		We hash the variable using the hashfunction. It requires inputs as
