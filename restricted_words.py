...
locations_strict = ['district', 'country', 'subcountry', 'parish', 'village', 'community', 'location', 'panchayat', 'compound', 'survey_location', 'county', 'subcounty', 'ciudad','distrito','villa','city', 'town', 'neighbourhood', 'vill', 'lc', 'barangay', 'brgy']
...
def get_fuzzy_restricted_words():
    fuzzy_restricted = fuzzy + spanish_fuzzy
